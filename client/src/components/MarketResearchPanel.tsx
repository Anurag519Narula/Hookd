    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 28, paddingTop: 24 }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{ marginLeft: "auto", fontSize: 13, color: "var(--text-3)", fontWeight: 500 }}>
        ...
        <div style={{
          ...
          <div style={{ padding: "16px 20px" }}>
            <div style={{ fontSize: 12, fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--text-3)", marginBottom: 8 }}>
              Opportunity
            </div>
          ...
          <div style={{ padding: "16px 20px" }}>
            ...
            <div style={{ fontSize: 13, color: trendColor(insights.trendDirection), fontWeight: 600, marginTop: 6 }}>
          ...
          <div style={{ padding: "16px 20px" }}>
            ...
            <div style={{ fontSize: 13, color: "var(--text-3)", marginTop: 6, lineHeight: 1.4 }}>
      ...
      <div>
        ...
        <p style={{ fontSize: 15, color: "var(--text-2)", lineHeight: 1.75, margin: "0 0 14px" }}>
          {insights.summary}
        </p>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 1, background: "var(--border)", borderRadius: 8, overflow: "hidden" }}>
            {[
              ...
              <div key={i} style={{
                ...
                <div style={{ fontSize: 12, fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--text-3)", marginBottom: 6 }}>
                  {stat.label}
                </div>
                ...
                <div style={{ fontSize: 13, color: "var(--text-3)", marginTop: 2 }}>{stat.sub}</div>
              </div>
            ))}
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginTop: 12 }}>
            {insights.youtubeData.topChannels.length > 0 && (
              <div style={{
                ...
                <div style={{ fontSize: 12, fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--text-3)", marginBottom: 10 }}>
                  Top Channels
                </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {insights.topAngles.map((a, i) => (
              <div key={i} style={{
                ...
                <span style={{
                  fontSize: 13, fontWeight: 700, color: i === 0 ? "#14b8a6" : "var(--text-3)",
                  paddingTop: 2,
                }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: 10 }}>
            {insights.untappedAngles.map((a, i) => (
              <div key={i} style={{
                ...
                <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "#34d399", marginBottom: 8 }}>
                  Gap #{i + 1}
                </div>
                <div style={{ fontSize: 15, fontWeight: 600, color: "var(--text)", marginBottom: 10, lineHeight: 1.4 }}>
                  {a.angle}
                </div>
            ...
            {insights.competitorInsights.map((c, i) => (
              <div key={i} style={{
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: 12, fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", color: "var(--text-3)", marginBottom: 5 }}>
                    What they do
                  </div>
                  <p style={{ fontSize: 14, color: "var(--text-2)", lineHeight: 1.6, margin: 0 }}>{c.observation}</p>
                </div>
                <div style={{
                  ...
                  border: "1px solid rgba(20,184,166,0.2)",
                  display: "flex", alignItems: "center", justifyContent: "center",
                  fontSize: 16, color: "#14b8a6", fontWeight: 700,
                  flexShrink: 0,
                }}>
                  →
                </div>
                <div style={{
                  ...
                  <div style={{ fontSize: 12, fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", color: "#14b8a6", marginBottom: 5 }}>
                    Your gap
                  </div>
                  <p style={{ fontSize: 14, color: "var(--text)", fontWeight: 500, lineHeight: 1.6, margin: 0 }}>{c.gap}</p>
                </div>
              </div>
            ))}
          </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              {insights.risks.map((r, i) => (
                <div key={i} style={{
                  ...
                  <span style={{ color: "#f87171", fontSize: 12, fontWeight: 700, flexShrink: 0, paddingTop: 2 }}>!</span>
                  <span style={{ fontSize: 14, color: "var(--text-2)", lineHeight: 1.6 }}>{r}</span>
                </div>
              ))}
            </div>
          </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              {insights.recommendations.map((rec, i) => (
                ...
                >
                  ...
                  <span style={{ fontSize: 14, color: "var(--text-2)", lineHeight: 1.6 }}>{rec}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "#14b8a6", marginBottom: 8 }}>
          Key Insight
        </div>
        <p style={{ fontSize: 16, color: "var(--text)", fontWeight: 500, lineHeight: 1.75, margin: 0, letterSpacing: "-0.01em" }}>
          {insights.keyInsight}
        </p>
      </div>
