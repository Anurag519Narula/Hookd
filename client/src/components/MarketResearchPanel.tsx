...
import {
  Pulse, CaretDown, Target, Binoculars,
  ListChecks, Warning as WarningIcon, Eye,
} from "@phosphor-icons/react";
import { InsightReport } from "../types/insights";
import { SectionLabel, Badge, reachColor, diffColor } from "./ui";
  ...
  return (
    <div style={{
      ...
      >
        ...
        <CaretDown
          size={16} weight="bold" color="var(--text-3)"
          style={{
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 32, paddingTop: 24 }}>
        ...
        <div>
          <SectionLabel>
            <span style={{ display: "inline-flex", alignItems: "center", gap: 6 }}>
              <Target size={13} weight="bold" /> Top Angles
            </span>
          </SectionLabel>
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {insights.topAngles.map((a, i) => (
              <motion.div
                ...
                onMouseEnter={(e) => {
                  if (i !== 0) e.currentTarget.style.borderColor = "var(--border-strong)";
                }}
                onMouseLeave={(e) => {
      ...
      {insights.untappedAngles.length > 0 && (
        <div>
          <SectionLabel>
            <span style={{ display: "inline-flex", alignItems: "center", gap: 6 }}>
              <Binoculars size={13} weight="bold" /> Untapped Angles
            </span>
          </SectionLabel>
          <div style={{
            display: "grid",
            ...
            {insights.untappedAngles.map((a, i) => (
              ...
              >
                ...
                <div style={{
                  fontSize: 14, color: "var(--text-2)", lineHeight: 1.65, marginBottom: 10,
                }}>{a.opportunity}</div>
                <div style={{
      ...
      {insights.recommendations.length > 0 && (
        <div>
          <SectionLabel>
            <span style={{ display: "inline-flex", alignItems: "center", gap: 6 }}>
              <ListChecks size={13} weight="bold" /> Action Plan
            </span>
          </SectionLabel>
      ...
      {insights.risks.length > 0 && (
        <div>
          <SectionLabel>
            <span style={{ display: "inline-flex", alignItems: "center", gap: 6 }}>
              <WarningIcon size={13} weight="bold" /> Risks to Watch
            </span>
          </SectionLabel>
          <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
      ...
      {insights.competitorInsights.length > 0 && (
        <div>
          <SectionLabel>
            <span style={{ display: "inline-flex", alignItems: "center", gap: 6 }}>
              <Eye size={13} weight="bold" /> Competitor Insights
            </span>
          </SectionLabel>
            ...
            {insights.competitorInsights.map((c, i) => (
              <div key={i} style={{
                ...
                <div style={{
                  ...
                  <p style={{ fontSize: 14, color: "var(--text)", fontWeight: 500, lineHeight: 1.65, margin: 0 }}>
                    {c.gap}
                  </p>
                </div>
              </div>
